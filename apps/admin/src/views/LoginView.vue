<template>
    <div class="main w-full h-screen bg-indigo-100 dark:bg-neutral-800 z-0 select-none">
        <div class="w-full h-screen z-50">
            <div
                class="flex items-center justify-center h-screen w-full md:w-6/12 max-w-lg m-auto p-4 z-50"
            >
                <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-2xl p-8 relative w-full border border-gray-100 dark:border-neutral-700">
                    <div
                        class="absolute w-full h-full top-0 left-0 right-0 bottom-0 bg-black opacity-60 flex items-center justify-center rounded-xl"
                        style="z-index: 9999"
                        v-if="loading"
                    >
                    ...
                    <h1 class="text-2xl font-bold text-center text-gray-800 dark:text-white mb-6">Welcome Back</h1>
                        ...
                        <div class="w-full">
                            <div class="mb-4">
                                ...
                                <input
                                    ...
                                    :disabled="loading"
                                    class="w-full px-4 py-3 rounded-lg border border-gray-200 dark:border-neutral-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-neutral-700 text-gray-900 dark:text-white select-text shadow-sm"
                                    required
                                />
                            ...
                            <button
                                type="submit"
                                class="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 shadow-md"
                                :disabled="loading"
                            >
                                Login
                            </button>
                            ...
                            <div class="mt-4 flex justify-between text-sm">
                                <router-link to="/register" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 font-medium">
                                    Create an account
                                </router-link>
                                <router-link to="/forgot-password" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 font-medium">
                                    Forgot password?
                                </router-link>
                            </div>
                        </div>
